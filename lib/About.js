        ...
        <div className="work">
          ...
          </h3>
          {
            this.props.previousWork.map((project, id)=>{
              return <section key={id}><h3>{project.projectName}</h3><p>{project.projectDescription}</p><img className="projectImage" src={"../assets/" + project.projectImg} alt={"image of" + project.projectName}/><a href={project.projectURL} target="_blank">Check out Website</a></section>
            })
          }
        </div>
        <div className="about">
